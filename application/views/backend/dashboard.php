...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="grid-container" style="margin-top: 20px;">
            ...
            <div class="card" style="--grad: #F44336, #E91E63;">
                ...
                <div class="content">
                    ...
                    <select id="positionFilter" class="form-select custom-select-sm mt-2 custom-dropdown"
                        style="width: 120px;">
                        ...
                        <option value="W1W Deposit">W1W Deposit</option>
                        <option value="W1W Withdrawal">W1W Withdrawal</option>
                    </select>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <script>
                $(document).ready(function () {
                    function loadMistakeCount(project = '') {
                        $.ajax({
            ...
            <script>
                document.getElementById('time-range-dropdown').addEventListener('change', function () {
                    ...
                    fetchOrderCount(timeRange);
                });

                function fetchOrderCount(timeRange) {

                    fetch(`<?= base_url('Dashboard/get_total_order_count/') ?>${timeRange}`)
