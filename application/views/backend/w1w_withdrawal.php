      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h5 class="text-themecolor"><i class="fa fa-archive" aria-hidden="true"></i> W1W Withdrawal Order Report</h>
                </div>
                
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">W1W Withdrawal Order</li>
                    </ol>
                </div>
            </div>
...
<body>
  ...
  <div class="row">
    ...
    <tbody>
       <?php foreach ($w1w_withdrawal as $order): ?>
    <tr>
...
function filterChart() {
  ...
  fetch(`<?= base_url('W_Order/get_all_orders_barline_chart') ?>?date_from=${startDate}&date_to=${endDate}`)
    .then(res => res.json())
    .then(data => {
      if (chart) {
...
function filterChart() {
  ...
  fetch(`<?= base_url('W_Order/get_all_orders_barline_chart') ?>?${params.toString()}`)
    .then(res => res.json())
    .then(data => {
