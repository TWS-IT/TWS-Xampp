            ...
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a
                        href="<?php echo base_url(); ?>employee/Add_employee" class="text-white"><i class=""
                            aria-hidden="true"></i> Add Employee</a></button>
                                        ...
                                        <tr>
                                            ...
                                            <td class="jsgrid-align-center ">
                                                ...
                                                <a onclick="return confirm('Are you sure to delete this data?')"
                                                    href="<?php echo base_url('employee/Delete_Employee?I=' . base64_encode($value->em_id)); ?>"
                                                    title="Delete" class="btn btn-sm btn-danger waves-effect waves-light">
