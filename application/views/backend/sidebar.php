...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
  ...
  <ul aria-expanded="false" class="collapse">
    ...
    <ul aria-expanded="false" class="collapse">
        ...
        <li><a href="<?php echo base_url(); ?>IR"> Warning Letter</a></li>
    </ul>
</li>
...
.sidebar-nav li:nth-child(1) a:hover { background-color: #ffe6e6; color: #d9534f; }
.sidebar-nav li:nth-child(2) a:hover { background-color: #fff2cc; color: #f0ad4e; }
.sidebar-nav li:nth-child(3) a:hover { background-color: #e2f0cb; color: #5cb85c; }
.sidebar-nav li:nth-child(4) a:hover { background-color: #d9edf7; color: #5bc0de; }
.sidebar-nav li:nth-child(5) a:hover { background-color: #e6e6ff; color: #7a71d4; }
.sidebar-nav li:nth-child(6) a:hover { background-color: #fce4ec; color: #ec407a; }
.sidebar-nav li:nth-child(7) a:hover { background-color: #f3e5f5; color: #9c27b0; }
.sidebar-nav li:nth-child(8) a:hover { background-color: #e8f5e9; color: #43a047; }
.sidebar-nav li:nth-child(9) a:hover { background-color: #fff3e0; color: #fb8c00; }
